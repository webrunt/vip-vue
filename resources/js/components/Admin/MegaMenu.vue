             ...
             <div class="grid lg:grid-cols-5 gap-5">
              ...
              <div class="flex flex-col">
               ...
               <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                ...
                <div class="kt-menu-item">
                 <a class="kt-menu-link" href="html/demo1/account/members/team-members-datatable.html" tabindex="0">
                  <span class="kt-menu-title grow-0">
            ...
            <div class="flex flex-col lg:flex-row">
             ...
             <div class="lg:w-[260px] mb-4 lg:mb-0 lg:border-s lg:border-s-border rounded-xl lg:rounded-e-xl lg:rounded-l-none shrink-0 px-3 py-4 lg:p-7.5 bg-muted/25">
              ...
              <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
               ...
               <div class="kt-menu-item">
                <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="html/demo1/authentication/welcome-message-2.html">
                 <span class="kt-menu-icon">
                  <i class="ki-filled ki-element-11">
                  </i>
                 </span>
